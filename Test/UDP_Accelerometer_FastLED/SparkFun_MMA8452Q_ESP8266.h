...
#ifndef SparkFun_MMA8452Q_ESP8266_h
#define SparkFun_MMA8452Q_ESP8266_h
...
public:	
	...
	byte init(MMA8452Q_Scale fsr = SCALE_2G, MMA8452Q_ODR odr = ODR_800, int pinA = D2 , int pinB = D1);
  void read();
	byte available();
	byte readTap();
	byte readPL();
